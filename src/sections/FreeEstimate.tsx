              ...
              <div className="mt-3 pt-3 border-t border-gray-200">
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-[11px] text-gray-600 leading-relaxed">
                    I agree to receive a one-time SMS review request from We Move On Demand after my move is completed. Message and data rates may apply. Reply STOP to opt out. View our Privacy Policy at wemoveondemand.com/privacy-policy and Terms & Conditions at wemoveondemand.com/terms-and-conditions
                  </span>
                </label>
              </div>
            </form>
