          ...
          <div className="bg-[#F3F3F1] rounded-3xl p-6 lg:p-8">
            ...
            <form onSubmit={onSubmit} className="space-y-3">
              ...
              <div className="mt-3 pt-3 border-t border-gray-200">
                <p className="text-[10px] text-gray-400 uppercase tracking-widest font-semibold mb-2">Optional</p>
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-[11px] text-gray-600 leading-relaxed">
                    I agree to receive SMS text messages from We Move On Demand, including service updates and a post-move review request. Message frequency varies. Message and data rates may apply. Reply STOP to opt out. View our Privacy Policy at wemoveondemand.com/privacy-policy and Terms & Conditions at wemoveondemand.com/terms-and-conditions
                  </span>
                </label>
              </div>
            </form>
